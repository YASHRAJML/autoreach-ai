...
// import CVAgent from './components/CVAgent/CVAgent'; // Temporarily commented out
import JobBucket from './components/JobBucket/JobBucket';
          ...
          <main className="flex-1 p-6">
            <Routes>
              ...
              <Route 
                ...
                element={
                  profile ? (
                    <div className="p-6"><h1 className="text-2xl font-bold">CV Agent Feature Coming Soon</h1></div>
                  ) : (
                    <Navigate to="/profile" replace />
                  )
                } 
